// DUPLICATED from webapp/app/components/Layout.tsx as of the marketing/app
// split (Phase 3, see docs/marketing-app-split-plan.md) -- kept identical
// so /login, /verify, /welcome/:token, /card/:fileId, and the public vault
// sharing pages render with the exact same chrome they had before the
// split. This is genuinely marketing site navigation (About, Tools, Good,
// etc.), which is a little odd to see on app-side pages -- worth
// reconsidering with app-native chrome as a follow-up, not attempted here.
// If you change this file, consider whether webapp's copy needs the same
// change (or vice versa) -- these two do NOT share an import.
