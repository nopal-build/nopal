...
export function ConfirmEmail({ code, type }: ConfirmEmailProps) {
  return (
    <div
      style={{
        color: "#3f2b46",
    ...
    >
      ...
      >
        <p style={{ margin: "0 0 16px", lineHeight: "1.6" }}>
          {type === "primary"
            ? "Confirm this is your new email address on Nopal:"
            : "Confirm this email address to add it as a login for your Nopal account:"}
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <span style={{ color: "#7f5b8b" }}>Code:</span>
          <code
            style={{
              border: "1px solid #e5d6c5",
              background: "#fff",
