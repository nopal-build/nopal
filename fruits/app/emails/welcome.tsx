  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Welcome to Nopal, {name}
        </h2>

        <p style={{ margin: "0 0 12px", lineHeight: "1.6" }}>
          {invitedByName ? (
            <>
              <strong>{invitedByName}</strong> invited you to join Nopal.
            </>
          ) : (
            <>You've been added to Nopal.</>
          )}
        </p>
        ...
        <p style={{ margin: "20px 0 0", fontSize: "13px", lineHeight: "1.6" }}>
          Prefer not to? You can always{" "}
          <a href={loginUrl} style={{ color: "#3f2b46" }}>
