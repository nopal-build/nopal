...
type Module = typeof import("../api.phylog.reset-pre-capture.js")

type Info = GetInfo<{
  file: "routes/api.phylog.reset-pre-capture.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.phylog.reset-pre-capture.js");
}];
