...
type Module = typeof import("../api.graphlog.graph-project-view.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.graph-project-view.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.graph-project-view.js");
}];
