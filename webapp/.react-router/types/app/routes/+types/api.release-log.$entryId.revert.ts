...
type Module = typeof import("../api.release-log.$entryId.revert.js")

type Info = GetInfo<{
  file: "routes/api.release-log.$entryId.revert.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.release-log.$entryId.revert.js");
}];
