...
type Module = typeof import("../fruits_.maker_.graphlog_.defaults.js")

type Info = GetInfo<{
  file: "routes/fruits_.maker_.graphlog_.defaults.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../fruits_.maker_.graphlog_.defaults.js");
}];
