...
type Module = typeof import("../api.legal-documents.view.$docId.js")

type Info = GetInfo<{
  file: "routes/api.legal-documents.view.$docId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.legal-documents.view.$docId.js");
}];
