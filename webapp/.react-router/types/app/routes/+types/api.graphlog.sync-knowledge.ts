...
type Module = typeof import("../api.graphlog.sync-knowledge.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.sync-knowledge.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.sync-knowledge.js");
}];
