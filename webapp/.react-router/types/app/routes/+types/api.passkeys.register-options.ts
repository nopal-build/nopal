...
type Module = typeof import("../api.passkeys.register-options.js")

type Info = GetInfo<{
  file: "routes/api.passkeys.register-options.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.passkeys.register-options.js");
}];
