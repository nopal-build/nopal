...
type Module = typeof import("../fruits_.maker_.graphlog_.runs.$runId.js")

type Info = GetInfo<{
  file: "routes/fruits_.maker_.graphlog_.runs.$runId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../fruits_.maker_.graphlog_.runs.$runId.js");
}];
