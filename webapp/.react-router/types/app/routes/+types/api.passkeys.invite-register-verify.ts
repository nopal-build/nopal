...
type Module = typeof import("../api.passkeys.invite-register-verify.js")

type Info = GetInfo<{
  file: "routes/api.passkeys.invite-register-verify.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.passkeys.invite-register-verify.js");
}];
