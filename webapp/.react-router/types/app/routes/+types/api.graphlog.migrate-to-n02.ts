...
type Module = typeof import("../api.graphlog.migrate-to-n02.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.migrate-to-n02.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.migrate-to-n02.js");
}];
