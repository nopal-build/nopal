...
type Module = typeof import("../api.graphlog.reset-project-view.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.reset-project-view.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.reset-project-view.js");
}];
