...
type Module = typeof import("../api.vault.folders.$folderId.children.js")

type Info = GetInfo<{
  file: "routes/api.vault.folders.$folderId.children.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.folders.$folderId.children.js");
}];
