...
type Module = typeof import("../api.vault.sync-api.$folderId.schema.js")

type Info = GetInfo<{
  file: "routes/api.vault.sync-api.$folderId.schema.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.sync-api.$folderId.schema.js");
}];
