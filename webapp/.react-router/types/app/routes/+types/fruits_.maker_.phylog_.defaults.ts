...
type Module = typeof import("../fruits_.maker_.phylog_.defaults.js")

type Info = GetInfo<{
  file: "routes/fruits_.maker_.phylog_.defaults.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../fruits_.maker_.phylog_.defaults.js");
}];
