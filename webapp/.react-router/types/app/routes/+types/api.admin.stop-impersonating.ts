...
type Module = typeof import("../api.admin.stop-impersonating.js")

type Info = GetInfo<{
  file: "routes/api.admin.stop-impersonating.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.admin.stop-impersonating.js");
}];
