...
type Module = typeof import("../api.passkeys.invite-register-options.js")

type Info = GetInfo<{
  file: "routes/api.passkeys.invite-register-options.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.passkeys.invite-register-options.js");
}];
