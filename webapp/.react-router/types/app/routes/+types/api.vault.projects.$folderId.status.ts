...
type Module = typeof import("../api.vault.projects.$folderId.status.js")

type Info = GetInfo<{
  file: "routes/api.vault.projects.$folderId.status.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.projects.$folderId.status.js");
}];
