...
type Module = typeof import("../api.vault.folders.$folderId.download-manifest.js")

type Info = GetInfo<{
  file: "routes/api.vault.folders.$folderId.download-manifest.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.folders.js");
}, {
  id: "routes/api.vault.folders.$folderId";
  module: typeof import("../api.vault.folders.$folderId.js");
}, {
  id: "routes/api.vault.folders.$folderId.download-manifest";
  module: typeof import("../api.vault.folders.$folderId.download-manifest.js");
}];
