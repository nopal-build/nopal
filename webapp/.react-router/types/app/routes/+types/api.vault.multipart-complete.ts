...
type Module = typeof import("../api.vault.multipart-complete.js")

type Info = GetInfo<{
  file: "routes/api.vault.multipart-complete.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.multipart-complete.js");
}];
