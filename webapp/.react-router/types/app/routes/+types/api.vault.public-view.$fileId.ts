...
type Module = typeof import("../api.vault.public-view.$fileId.js")

type Info = GetInfo<{
  file: "routes/api.vault.public-view.$fileId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.public-view.$fileId.js");
}];
