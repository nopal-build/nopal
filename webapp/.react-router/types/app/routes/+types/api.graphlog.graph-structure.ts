...
type Module = typeof import("../api.graphlog.graph-structure.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.graph-structure.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.graph-structure.js");
}];
