...
type Module = typeof import("../api.vault.website.$folderId.settings.js")

type Info = GetInfo<{
  file: "routes/api.vault.website.$folderId.settings.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.website.$folderId.settings.js");
}];
