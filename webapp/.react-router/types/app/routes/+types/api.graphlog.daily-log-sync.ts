...
type Module = typeof import("../api.graphlog.daily-log-sync.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.daily-log-sync.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.daily-log-sync.js");
}];
