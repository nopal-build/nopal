...
type Module = typeof import("../api.admin.impersonation-status.js")

type Info = GetInfo<{
  file: "routes/api.admin.impersonation-status.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.admin.impersonation-status.js");
}];
