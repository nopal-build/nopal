...
type Module = typeof import("../api.vault.public-download.$fileId.js")

type Info = GetInfo<{
  file: "routes/api.vault.public-download.$fileId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.public-download.$fileId.js");
}];
