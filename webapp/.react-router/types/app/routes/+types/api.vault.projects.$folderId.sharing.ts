...
type Module = typeof import("../api.vault.projects.$folderId.sharing.js")

type Info = GetInfo<{
  file: "routes/api.vault.projects.$folderId.sharing.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.vault.projects.$folderId.sharing.js");
}];
