...
type Module = typeof import("../api.graphlog.reset-knowledge.js")

type Info = GetInfo<{
  file: "routes/api.graphlog.reset-knowledge.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.graphlog.reset-knowledge.js");
}];
