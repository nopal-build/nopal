type EmailChangeNoticeProps = {
  changedEmail: string;
  reason: "alias-added" | "primary-changed";
};
...
export function EmailChangeNotice({
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ margin: "0 0 16px", color: "#3f2b46", fontSize: "18px" }}>
          Your account's login email changed
        </h2>
        <p style={{ margin: "0 0 12px", lineHeight: "1.6" }}>
          {reason === "primary-changed" ? (
            ...
            <>
              <strong>{changedEmail}</strong> was just added as an
              additional login for your Nopal account.
            </>
          )}
        </p>
        <p style={{ margin: 0, lineHeight: "1.6" }}>
          If this wasn't you, someone may have access to your account —
          reply to this email or reach out to your Nopal admin right away.
        </p>
      </div>
    </div>
  );
